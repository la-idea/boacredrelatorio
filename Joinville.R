...
original <- read_csv2("Joinville_original.csv")
relatorio1 <- read_csv2("Pref_Joinville_Relatório_1.csv")
relatorio2 <- read_csv2("Pref_Joinville_Relatório_2.csv")
...
original["cidade"] <- "Joinville"
relatorio1["cidade"] <- "Joinville"
relatorio2["cidade"] <- "Joinville"
...
write_csv2(atendidas_rel1, "atendidas_etapa1_joinville.csv")
write_csv2(clientes2,"clientes_joinville.csv")
write_csv2(atendidas, "atendidas_joinville.csv")
...
colnames(contagem_colunas_telefone) <- c("Telefone1", "Telefone2", "Telefone3",
                                         ...
                                         "Telefone7")
write_csv2(contagem_colunas_telefone, "Joinvile Contagem Sucesso de Colunas Telefone.csv")
...
write_csv2(contagem_fixo_cel, "Joinville Contagem de quantos fixos e celulares.csv")
